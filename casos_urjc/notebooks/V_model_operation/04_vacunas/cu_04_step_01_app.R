...
ui <- function(request){
  fluidPage(
             ...
             tabsetPanel(id = "tszonas",
                         tabPanel("Fichero de ejemplo",
                                  pickerInput(
                                    ...
                                    choices = c("CU_04_05_01_zonasgeo.json"),
                                    options = list(
    ...
    ## fichero histórico ----
    fluidRow(
      h3("Fichero de histórico vacunación"),
      column(4,
             tabsetPanel(id = "tshistorico",
                         tabPanel("Fichero de ejemplo",
                                  pickerInput(
                                    ...
                                    choices = c("CU_04_05_16_vacunacion_gripe.csv"),
                                    options = list(
                                      title = "Seleccione un fichero")
                                  )
                         ),
    ...
    ## fichero indicadores ----
    fluidRow(
      h3("Fichero de indicadores socioeconómicos"),
      column(4,
             tabsetPanel(id = "tsindicadores",
                         tabPanel("Fichero de ejemplo",
                                  pickerInput(
                                    ...
                                    choices = c("CU_04_05_17_indicadores_vacunacion.csv"),
                                    options = list(
                                      title = "Seleccione un fichero")
                                  ),
                                  pickerInput(
             ...
             tabsetPanel(id = "tsescucha",
                         tabPanel("Fichero de ejemplo",
                                  pickerInput(
                                    ...
                                    choices = c("CU_04_05_18_escucha_gripe.csv"),
                                    options = list(
                                      title = "Seleccione un fichero")
                                  )
                         ),
    ...
    hr(),
    # fluidRow(
    ## fichero nueva campaña ----
    fluidRow(
      h3("Campaña en curso"),
      column(4,
             tabsetPanel(id = "tsnuevacampana",
                         tabPanel("Fichero de ejemplo",
                                  pickerInput(
                                    inputId = "pinuevacampana",
                                    label = "Fichero campaña actual",
                                    choices = c("NUEVACAMPANA.csv"),
                                    options = list(
                                      title = "Seleccione un fichero")
                                  )
                         ),
      ...
      column(8,
             dataTableOutput("tnuevacampana")
      ),
    ),
    hr(),
    ## fichero nueva capacidad ----
    fluidRow(
      h3("Capacidad campaña en curso"),
      column(4,
             tabsetPanel(id = "tsnuevacapacidad",
                         tabPanel("Fichero de ejemplo",
                                  pickerInput(
                                    inputId = "pinuevacapacidad",
                                    label = "Fichero capacidad campaña actual",
                                    choices = c("CAPACIDAD.csv"),
                                    options = list(
                                      title = "Seleccione un fichero")
                                  )
                         ),
      ...
      column(8,
             dataTableOutput("tnuevacapacidad")
      ),
    ),
    hr(),
    # fluidRow(
